...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, fitness, and competitive soccer skills",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Build endurance and technique in swim training sessions",
    ...
    "Science Olympiad": {
        "description": "Solve challenging science and engineering problems",
...
def remove_signup_from_activity(activity_name: str, email: str):
